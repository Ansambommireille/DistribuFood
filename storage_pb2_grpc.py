...
class StorageNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StoreBlock = channel.unary_unary(
                '/storage.StorageNode/StoreBlock',
        ...
        self.DeleteBlock = channel.unary_unary(
                '/storage.StorageNode/DeleteBlock',
...
def add_StorageNodeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetAvailableSpace': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAvailableSpace,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'storage.StorageNode', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('storage.StorageNode', rpc_method_handlers)
